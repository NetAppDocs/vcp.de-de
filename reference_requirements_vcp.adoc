...
Für vCenter Server 8.0 und 7.0 ist dies möglich <<create_vcp_role,Erstellen Sie eine „VCP Rolle“ in vCenter>> Für ein Element Plug-in-Benutzerkonto und Zuweisen von Berechtigungen zum Registrieren oder Aktualisieren des Element Plug-ins für vCenter Server und Ausführen von Element Plug-in-Verwaltungsaufgaben.
...
Für vCenter Server 8.0 und 7.0 können Sie in vCenter für ein Element Plug-in-Benutzerkonto eine „VCP-Rolle“ erstellen und Berechtigungen zur Registrierung oder Aktualisierung des Element Plug-in für vCenter Server zuweisen sowie Element Plug-in-Verwaltungsaufgaben durchführen.
