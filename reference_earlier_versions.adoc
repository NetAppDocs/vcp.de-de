...
[role="lead"]
Die Dokumentation ist auch für Versionen vor Version 5.2 des NetApp Element-Plug-ins für VMware vCenter Server verfügbar.


NOTE: Das link:index.html["Link zur Dokumentation"] Für Element vCenter Plug-in 5.2 umfasst außerdem Versionen 5.1, 5.0, 4.10, 4.9 und 4.8 4.7 und 4.6.
