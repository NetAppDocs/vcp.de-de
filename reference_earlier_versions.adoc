...
[role="lead"]
Die Dokumentation ist auch für Versionen vor Version 5.3 des NetApp Element-Plug-ins für VMware vCenter Server verfügbar.


NOTE: Das link:index.html["Link zur Dokumentation"] Für Element vCenter Plug-in 5.3 umfasst außerdem Versionen 5.2, 5.1, 5.0, 4.10 und 4.9 4.8, 4.7 und 4.6.
