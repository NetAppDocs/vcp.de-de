...
[role="lead"]
Das Element vCenter Plug-in Version 5.4 enthält keine neuen Verbesserungen.

Das Element vCenter Plug-in 5.4 ist mit Version 2.26.30 der Management-Services verfügbar. link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3330676["Weitere Informationen ."^]
